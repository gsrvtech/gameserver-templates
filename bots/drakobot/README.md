...
**DrakoBot** is a Discord bot built with Discord.js and Node.js. It runs with a bundled MongoDB instance inside the container, making self-hosting straightforward with no external database required.

---

## Download this Egg

This is a **Pelican** YAML egg (`egg-drako-bot.yaml`).
